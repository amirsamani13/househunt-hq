...
ADD CONSTRAINT IF NOT EXISTS properties_source_external_id_key UNIQUE (source, external_id);
...
ADD CONSTRAINT IF NOT EXISTS notifications_user_property_unique UNIQUE (user_id, property_id);
